...
if (document.querySelector('.naws__swiper')) {
   const swiper = new Swiper('.naws__swiper', {
      keyboard: {
         enabled: true,
         onlyInViewport: true,
      },
...
if (document.querySelector('.swiper-brand-main')) {
   const swiper = new Swiper('.swiper-brand-main', {
      ...
      spaceBetween: 10,
      pagination: {
         el: '.swiper-brand-main-pagination',
         clickable: true,
      },
      navigation: {
         nextEl: '.swiper-brand-main-next',
         prevEl: '.swiper-brand-main-prev',
      },
      breakpoints: {
         768: {
            slidesPerView: 4,
